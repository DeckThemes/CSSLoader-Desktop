          ...
          {showNewBackendPage || (!backendExists && !dummyResult) ? (
            ...
            <>
              {dummyResult ? (
                <>
                  <MainNav />
                  <main className="page-shadow ml-4 mt-[128px] mb-4 flex h-full flex-1 flex-grow flex-col rounded-3xl border-[1px] border-borders-base3-light bg-base-2-light dark:border-borders-base1-dark dark:bg-base-2-dark sm:mt-[64px]">
                    <Component {...pageProps} />
                  </main>
                </>
              ) : (
